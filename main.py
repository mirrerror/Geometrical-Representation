...
img_loader.show_image(img_preproc.thresholding(img, 128))
img_loader.show_image(img_preproc.contrast_adjustment(img))
img_loader.show_image(img_preproc.detect_edges(img))
